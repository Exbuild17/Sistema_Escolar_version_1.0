...
<body class="container mt-5">
    ...
    <form action="guardar_alumno.php" method="POST">
        ...
        <input type="text" name="direccion" class="form-control mb-3" placeholder="Direccion Alumno">
        <input type="text" name="telefono" class="form-control mb-3" placeholder="Telefono Alumno">
